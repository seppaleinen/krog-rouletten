# coding=UTF-8
import sys, mock, os, time, requests_mock, json, jsonpickle
from os import path
...
class UnitTests(TestCase):
    ...
    def test_error_page(self):
        ...
        self.assertEquals('500 INTERNAL SERVER ERROR', result.status)
        self.assertTrue('error_msg' in result.get_data(as_text=True))
    ...
    def test_details_page_without_location(self, mocked_get):
        ...
        bodyobj = jsonpickle.decode(body)
        self.assertTrue('Berns' in body, 'No mention of berns')
        self.assertEquals('N\u00e4ckstr\u00f6msgatan 8, 111 47 Stockholm, Sweden', bodyobj.adress)
        #self.assertTrue('N\u00e4ckstr\u00f6msgatan 8, 111 47 Stockholm, Sweden' in body, body)
        #self.assertTrue('Näckströmsgatan 8, 111 47 Stockholm, Sweden' in body, body)
        self.assertTrue('Bonyo Buogha' in body, body)
    ...
    def test_details_page_with_location(self, mocked_get):
        ...
        body = result.get_data(as_text=True)
        bodyObj = jsonpickle.decode(body)
        self.assertTrue('Berns' in body, body)
        self.assertEquals('N\u00e4ckstr\u00f6msgatan 8, 111 47 Stockholm, Sweden', bodyObj.adress)
    #    self.assertTrue('Näckströmsgatan 8, 111 47 Stockholm, Sweden' in body, body)
        self.assertTrue('Bonyo Buogha' in body, body)
    ...
    def test_search_stadsdel(self, mocked_get):
        ...
        mocked_get.assert_called_with(u'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=lat,lng&radius=500&type=bar&key=None')
